...
"Fundaci&oacute;n Bicentenaria Ayacucho"            
		    ...
		    <table border="0" bgcolor="#CDE1D6" width="83%" cellpadding="0" cellspacing="0">
					...
					<!-- Menu Izquierda -->
												...
												<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="">
													...
													<tr>
														<td class="menu_main"><a href="reg_nu.php"class="menu_main_link_l">Nuevo Voluntario </a></TD>
													</tr>
													
													<tr>
														<td class="menu_main"><a href="principal.php"class="menu_main_link_l">Ingresar al  Sistema </a></TD>
													</tr>
													<tr>
														<td class="menu_main"><a href="noticias.php"class="menu_main_link_l">Noticias </a></TD>
													</tr>
      ...
      <tr>
        <td width="1%">&nbsp;</td>
        <td height="430" align="center" valign="top"><table width="100%"  border="0"  bordercolor="#990033"     bgcolor=""><br><font class="Estilo9" ><table width="100%"  border="0"  bordercolor="#990033"   bgcolor="" >
       
       <caption align="top"  class=" boxcolor3" >Vanguardia Bicentenaria Ayacucho (Fundavanguardia)</caption> <tr>
...
<table align="center" >
<tr align="center" ><td><p align="justify" class="boxcolor2"> Somos un colectivo conformado por los becarios, becarias, voluntarios y voluntarias, de la Fundación Gran Mariscal de Ayacucho.  Como actores protagónicos de la revolución bolivariana, buscamos promover el proceso de transformación de las universidades nacionales, hacia la reivindicación de la población estudiantil indígena, afrodescendiente, la inclusión de las personas con discapacidad y la dignificación de las madres estudiantes universitarias.
Promovemos la creación de los consejos estudiantiles, para desmontar las viejas estructuras representativas y realizar actividades de formación, ambientales, culturales y recreativas que buscan alcanzar niveles de conciencia que permitan generar pensamientos críticos e integradores a través del intercambio de saberes, entre nosotros y con las comunidades.<br>Venimos de una organización de base, consolidada en el Encuentro Nacional de Becarios, Becarias, Voluntarios y Voluntarias de Fundayacucho en octubre de 2010, con la participación de más de trescientos jóvenes de todo el país, quienes de manera democrática y colectiva, acordamos consolidar este movimiento y ejecutar el Fondo de Ahorro Social del 1% del Aporte Mensual como herramienta para la lucha revolucionaria, no como un beneficio individual, sino como una responsabilidad colectiva. </p></a></td></tr>
</table>                      

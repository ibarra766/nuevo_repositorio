		    ...
		    <table border="0" bgcolor="#CDE1D6" width="83%" cellpadding="0" cellspacing="0">
					...
					<!-- Menu Izquierda -->
												...
												<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="">
													...
													<tr>
														<td class="menu_main"><a href="reg_noti.php"class="menu_main_link_l">Registrar Noticias </a></TD>
													</tr>
                                                    <tr>
														<td class="menu_main"><a href="re_act.php"class="menu_main_link_l">Registrar Actividad </a></TD>
													</tr>
...
<form action="registro.php" method="POST" name="bus">
<tr><td class="boxcolor" >Cedula:</td><td><input name="cedul" type="text" size="12" ><input  type="submit"  onclick="MM_validateForm('cedula1','','RisNum');return document.MM_returnValue" Value=Buscar ></td><td class="Estilo6"></td></tr>
</form>
</table> 
<hr>           
                       
 <form action="re_us.php" method="post" name="form">
 <table align="center" border="0" bordercolor="">
<tr>

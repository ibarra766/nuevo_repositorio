...
"Fundaci&oacute;n Bicentenaria Ayacucho"            
      ...
      <tr>
        <td width="1%">&nbsp;</td>
        <td height="430" align="center" valign="top"><br><br><br><br><table width="100%"  border="0"  bordercolor=""     bgcolor="">
        ...
        <tr>
           ...
           <td align="center" >
                       <table  bgcolor="">
                       <caption>
                       <h3  class="Estilo9"	>Ingreso de Administrador</h3><img src="Imagenes/bb.png" width="250" height="15"></caption>

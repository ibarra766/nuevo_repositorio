...
"Fundaci&oacute;n Bicentenaria Ayacucho"            
		    ...
		    <table border="0" bgcolor="#CDE1D6" width="83%" cellpadding="0" cellspacing="0">
					...
					<!-- Menu Izquierda -->
												...
												<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="">
													...
													<tr>
														<td class="menu_main"><a href="reg_nu.php"class="menu_main_link_l">Registrar Voluntario </a></TD>
													</tr>
      ...
      <tr>
        <td width="1%">&nbsp;</td>
        <td height="430" align="center" valign="top"><table width="100%"  border="0"  bordercolor="#990033"     bgcolor=""><br><font class="Estilo9" ></font> <br><table width="100%"  border="0"  bordercolor="#990033"   bgcolor="" >
       
       <caption align="top"  class=" Estilo9" >REGISTRO DE NUEVO VOLUNTARIO</caption> <tr>
        
            <td>
      
                       
 <form action="renu.php" method="post" name="form">
 <table align="center" border="0" bordercolor="#006633">
<tr>

<td  class="boxcolor" align="left">
 Nombres:</td><td><input type="text" name="nombre" size="25" value="Ingrese Nombres">
  </td>
<td  class="boxcolor">

Apellidos:</td><td><input type="text" name="apellido" size="25" value="Ingrese Apellidos" >
...
<td  class="boxcolor" align="left">
 Cedula:</td><td><input type="text" name="cedula" size="15" value="Ingrese Cedula" >
  </td>
<td  class="boxcolor">

Correo:</td><td><input type="text" name="correo" size="20" value="ejemplo@hotmail.com">
...
<td  class="boxcolor" align="left">
 Telefono:</td><td><input type="text" name="telefono" size="15"  >
  </td>
<td  class="boxcolor">

Universidad:</td><td><input type="text" name="universidad" size="30" >
...
Municipio:</td><td><input type="text" name="municipio" size="25" >
...
Login:</td><td><input type="text" name="login" size="25" >
...
<td  class="boxcolor" align="left">
 Password:</td><td><input type="password" name="password" size="15" ><input  name="nivel" type="hidden" value="2" >

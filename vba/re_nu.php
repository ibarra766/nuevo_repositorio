...
"Fundaci&oacute;n Bicentenaria Ayacucho"            
		    ...
		    <table border="0" bgcolor="#CDE1D6" width="83%" cellpadding="0" cellspacing="0">
					...
					<!-- Menu Izquierda -->
												...
												<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="">
													...
													<tr>
														<td class="menu_main"><a href="re_nu.php"class="menu_main_link_l">Registrar Voluntario </a></TD>
													</tr>
      ...
      <tr>
        <td width="1%">&nbsp;</td>
        <td height="430" align="center" valign="top"><table width="100%"  border="0"  bordercolor="#990033"     bgcolor=""><br><font class="Estilo9" >Bienvenido:</font> <br><table width="100%"  border="0"  bordercolor="#990033"   bgcolor="" >
...
<td  class="boxcolor" align="left">
 </td><td><input  name="nivel" type="hidden" value="2" >
...
<td  class="boxcolor" align="left">
 Password:</td><td><input type="password" name="password" size="15" >
  </td>
</tr>
 <tr><td align="right">
